      ...
      <main id="top">
        ...
        <section id="contact" class="section wrap">
          <div class="contact" data-reveal>
            ...
            <div class="contact-card"><div data-whatsapp-quote-form></div><span class="contact-number">${phone}</span><a class="btn primary" href="${wa}" target="_blank" rel="noopener">${ui("Send a WhatsApp message", "WhatsApp üzenet küldése")}</a><a class="btn" href="${tel}" data-phone-action data-phone-label>${phoneActionLabel()}</a><small>${state.lang === "hu" ? "Rövid üzenet is elég: fotók, helyszín, határidő. Elsődleges terület: Budapest és közvetlen környéke." : "A short message is enough: photos, location and timing. Primary service area: Budapest and nearby locations."}</small></div>
          </div>
        </section>
      </main>
